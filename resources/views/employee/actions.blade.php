<div class="d-flex">
    ...
    <form action="{{ route('employees.destroy', ['employee' => $employee->id]) }}" method="POST">
        ...
        @method('delete')
        <button type="submit"
            class="btn btn-outline-dark btn-sm me-2 d-flex align-items-center justify-content-center btn-delete"
            style="width: 40px; height: 40px;" data-name="{{ $employee->firstname . ' ' . $employee->lastname }}">
